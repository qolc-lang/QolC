...
int isNumber(char buffer[], int pos, int len, lexer_node* myNode, char* temp_buffer){
 ...
 if (
# 33 "./src/checking_functions.c" 3 4
    ((((__locale_ctype_ptr ())+sizeof(""[
# 33 "./src/checking_functions.c"
    buffer[pos]
# 33 "./src/checking_functions.c" 3 4
    ]))[(int)(
# 33 "./src/checking_functions.c"
...
# 33 "./src/checking_functions.c"
  ...
  do {
   if (pos < len) {
    if (
# 40 "./src/checking_functions.c" 3 4
       ((((__locale_ctype_ptr ())+sizeof(""[
# 40 "./src/checking_functions.c"
       buffer[pos]
# 40 "./src/checking_functions.c" 3 4
       ]))[(int)(
# 40 "./src/checking_functions.c"
...
# 40 "./src/checking_functions.c"
     ...
     if (buf [0] == '0') {
      ...
      ++j;
      while (
# 52 "./src/checking_functions.c" 3 4
            ((((__locale_ctype_ptr ())+sizeof(""[
# 52 "./src/checking_functions.c"
            buffer[pos]
# 52 "./src/checking_functions.c" 3 4
            ]))[(int)(
# 52 "./src/checking_functions.c"
...
# 61 "./src/checking_functions.c" 3 4
         ((((__locale_ctype_ptr ())+sizeof(""[
# 61 "./src/checking_functions.c"
         buffer[pos]
# 61 "./src/checking_functions.c" 3 4
         ]))[(int)(
# 61 "./src/checking_functions.c"
...
# 61 "./src/checking_functions.c"
                              || buffer[pos] == '.' || buffer[pos] == 'x');
  if (buf[1] == 'x') {
   pushForLex(buf, "hexadecimal number", myNode);
  } else {
   pushForLex(buf, "number", myNode);
  }
  return count;
 }
 return -1;
  ...
  if (pos < len) {
   if (buffer[pos] == '='){
    ...
    if (buffer[pos] == '='){
     ...
     memset(temp_buffer, 0, sizeof(char));
     return count;
    }
    else{
     strcpy(temp_buffer, "operator,@=");
...
int isChar(char buffer[], int pos, int len, lexer_node* myNode, char* temp_buffer) {
 ...
 if (buffer[pos] == '\'') {
  ...
  pushForLex(buf, "character", myNode);
  ++count;
  return count;
 }
 return -1;
