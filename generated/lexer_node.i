...
# 97 "./src/lexer_node.c"
    ...
    current->next->next = 
# 102 "./src/lexer_node.c" 3 4
                         ((void *)0)
# 102 "./src/lexer_node.c"
                             ;
}
