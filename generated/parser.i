...
# 846 "./src/parser.c"
   ...
   else if (strcmp(theStack[top], "@==") == 0)
   {
    ...
    if ((empty(&top) == 0) && (doneFlag == 0)) {
     ...
     if (strcmp(theStack[top], "int") == 0) {
     ...
     else if (strcmp(theStack[top], "bool") == 0) {
      doneFlag = 1;
      theStack[0][top] = '\0';
      pop(&top);
      strcpy(temp, theStack[top]);
      ...
      if (floatValue[0] != '\0') {
       printf("Now the floatValue : %s\n", floatValue);
       printf("Now in the stack 1 : %s\n", theStack[top]);
...
# 1257 "./src/parser.c"
     ...
     decl* float_declaration = decl_create(theStack[top], float_type, 
